...
public plugin_precache() {
  ...
  g_iCwHandler = CW_Register(ZP_WEAPON_MAGNUM, CSW_DEAGLE, 6, ZP_Ammo_GetId(ZP_Ammo_GetHandler(ZP_AMMO_MAGNUM)), 24, _, _, 1, 6, _, "fiveseven");
...
public @Weapon_PrimaryAttack(this) {
  ...
  if (CW_DefaultShot(this, 80.0, 1.0, Float:VECTOR_CONE_1DEGREES)) {
