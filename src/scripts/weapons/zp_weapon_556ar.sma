...
public @Weapon_PrimaryAttack(this) {
  ...
  UTIL_CalculateWeaponSpread(this, Float:VECTOR_CONE_6DEGREES, 3.0, 0.95, 3.5, vecSpread);

  if (CW_DefaultShot(this, 20.0, 0.095, Float:vecSpread)) {
