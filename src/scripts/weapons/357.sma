...
public plugin_precache() {
  ...
  Asset_Precache(ASSET_LIBRARY, ASSET_SOUND(MagnumShot));
...
@Weapon_Create(const this) {
  ...
  CW_SetMember(this, WEAPON_BASE_MEMBER(flWeight), Asset_GetFloat(ASSET_LIBRARY, ASSET_VARIABLE(flMagnumWeight)));
}
...
@Weapon_PrimaryAttack(const this) {
  ...
  if (CW_CallNativeMethod(this, CW_Method_DefaultShot, 80.0, 0.9, 0.5, vecSpread, 1)) {
    ...
    Asset_EmitSound(pPlayer, CHAN_WEAPON, ASSET_LIBRARY, ASSET_SOUND(MagnumShot));
